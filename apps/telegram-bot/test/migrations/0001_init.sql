-- Mirror of apps/poller/migrations/0001_init.sql for telegram-bot test harness.
-- Keep in sync when poller migrations change.
-- TODO(모진영): after PR #2/#3/#4/this PR merge, extract to packages/migrations
-- or add a CI diff check to guard against drift.
