...
const TELEGRAM_BOT_USERNAME = process.env.NEXT_PUBLIC_TELEGRAM_BOT_USERNAME ?? 'rwa_sentinel_bot';
...
export const PREMIUM_WAITLIST_LINK = 'mailto:hello@oclixlabs.xyz?subject=Premium%20waitlist';
